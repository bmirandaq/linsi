...
<div className="flow-benefits__grid">
...
<span className="material-symbols-outlined flow-benefit__icon" aria-hidden="true">troubleshoot</span>
...
<span className="material-symbols-outlined flow-benefit__icon" aria-hidden="true">visibility</span>
...
<span className="material-symbols-outlined flow-benefit__icon" aria-hidden="true">handshake</span>
...
<span className="material-symbols-outlined flow-benefit__icon" aria-hidden="true">savings</span>
...
<aside className="flow-statement" aria-label="Relação com a LINSI">
